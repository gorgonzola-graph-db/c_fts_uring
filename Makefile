...
WAL_SRCS = src/slotted_page.c src/wal.c src/fts_vfs.c src/buffer_pool.c src/shm_manager.c src/main_wal_bp.c
WAL_OBJS = $(WAL_SRCS:.c=.o)

P23_SRCS = src/slotted_page.c src/wal.c src/fts_vfs.c src/buffer_pool.c src/btree.c src/fts_indexer.c src/main_phase2_3.c
P23_OBJS = $(P23_SRCS:.c=.o)

TARGETS = c_fts_poc c_tabular_poc c_wal_bp_poc c_phase2_3_poc fts_uring.so fts_shell

VTAB_SRCS = src/vtab_bridge.c src/unified_shard.c src/wal.c src/fts_vfs.c src/buffer_pool.c \
